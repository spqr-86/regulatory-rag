...
@patch("src.infra.llm_factory.ChatOpenAI")
def test_get_llm_openai(mock_openai):
    from src.infra.llm_factory import get_llm

    mock_openai.return_value = MagicMock()
    with patch("src.infra.llm_factory.settings") as mock_settings:
...
@patch("src.infra.llm_factory.ChatGoogleGenerativeAI")
...
def test_get_simple_llm_differs_from_get_gemini_llm(mock_chat):
    ...
    cost-saving split.
    """
    from src.infra.llm_factory import get_gemini_llm, get_simple_llm
