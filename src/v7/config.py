...
class V7Config(BaseSettings):
    ...
    # единственном владельце обрезки. Значение 30 сохраняет прежний фактический
    # контракт bridge._generate и не режет simple top-12 до проверки/эскалации.
    # Реальный размер дополнительно ограничен PACK_TOKEN_BUDGET.
    MAX_CHUNKS_FOR_LLM: int = 30
