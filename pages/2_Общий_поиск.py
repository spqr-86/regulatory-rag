"""Secondary line: generic Regulatory RAG chat over GOST/SNiP/SP (spec §6).

The main flow is the department Q&A on ``app.py``; this page keeps the generic
product line (the one behind the 56-question showcase eval) reachable.
"""
